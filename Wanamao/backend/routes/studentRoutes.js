...
router.post('/register', async (req, res) => {
    try {
        const {
            firstName, lastName, middleInitial, extensionName,
            studentId, year, faculty, program, profilePic
        } = req.body;

        // Default password is studentId
        ...
        const student = new Student({
            firstName, lastName, middleInitial, extensionName,
            studentId, year, faculty, program, profilePic, password
        });
