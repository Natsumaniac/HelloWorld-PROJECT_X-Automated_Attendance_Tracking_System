    ...
    try {
      ...
      if (response.data.success) {
        await AsyncStorage.multiSet([
          ['studentId', response.data.student.studentId], // <-- fix here
        ...
        setTimeout(() => {
          navigation.replace('StudentDashboard', { 
            studentData: {
              idNumber: response.data.student.studentId, // <-- fix here
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.formCard}>
          ...
          <TouchableOpacity
            style={{ marginTop: 16 }}
            onPress={() => navigation.navigate('ForgotPasswordStudent')}
          >
