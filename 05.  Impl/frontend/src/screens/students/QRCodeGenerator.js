...
const QRCodeGenerator = () => {
  ...
  // For student QR, just show the QR for their ID
  if (studentId) {
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fffbe7' }}>
        ...
        >
          <Ionicons name="arrow-back" size={22} color="#165973" />
          <Text style={{ marginLeft: 6, color: '#165973', fontWeight: 'bold', fontSize: 16 }}>Back</Text>
        </TouchableOpacity>
        <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 24, color: '#bfa100', marginTop: 40 }}>
          Your QR Code
        </Text>
        <QRCode
          value={studentId}
        ...
        />
        <Text style={{ marginTop: 24, color: '#22223b', fontSize: 16 }}>
